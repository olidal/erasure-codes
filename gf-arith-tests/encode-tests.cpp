...
int main()
{
	bool results[] = {
		...
		mul_add_row_test(666,    &ssse3::mul_add_row),
		mul_add_row_test(1,      &ssse3::mul_add_row),
		mul_add_row_test(519217, &ssse3::mul_add_row),
		mul_add_row_test(32,     &avx2::mul_add_row),
		mul_add_row_test(666,    &avx2::mul_add_row),
		mul_add_row_test(1,      &avx2::mul_add_row),
		mul_add_row_test(519217, &avx2::mul_add_row),
		...
		mul_row_test(666,    &ssse3::mul_row),
		mul_row_test(1,      &ssse3::mul_row),
		mul_row_test(519217, &ssse3::mul_row),
		mul_row_test(32,     &avx2::mul_row),
		mul_row_test(666,    &avx2::mul_row),
		mul_row_test(1,      &avx2::mul_row),
		mul_row_test(519217, &avx2::mul_row),
	};
